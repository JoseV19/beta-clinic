...
export default function LandingPage() {
  ...
  return (
    <div className="relative min-h-screen overflow-x-hidden bg-[#0F172A] text-clinical-white">
      ...
      {/* ─── Navbar ──────────────────────────────────────── */}
      <nav className="fixed inset-x-0 top-0 z-50 border-b border-white/[0.06] bg-[#0F172A]/90 backdrop-blur-sm">
        <div className="mx-auto flex max-w-6xl items-center justify-between px-6 py-3.5">
          ...
          <div className="hidden items-center gap-1 md:flex">
            ...
            <SignedOut>
              <Link
                to="/sign-in"
                className="ml-2 rounded-lg bg-beta-mint px-5 py-2 text-sm font-semibold text-[#0F172A] transition-colors hover:bg-beta-mint/90"
              >
                Acceso Clientes
              </Link>
            </SignedOut>
        ...
        {menuOpen && (
          <motion.div
            ...
            className="border-t border-white/[0.06] bg-[#0F172A] px-6 pb-4 pt-2 md:hidden"
          >
            <a
              href="#modulos"
            ...
            <SignedOut>
              <Link
                to="/sign-in"
                onClick={() => setMenuOpen(false)}
                className="mt-2 block rounded-lg bg-beta-mint px-4 py-3 text-center text-sm font-semibold text-[#0F172A]"
              >
                Acceso Clientes
              </Link>
            </SignedOut>
      ...
      <section className="relative z-10 flex min-h-screen items-center justify-center px-6">
        <div className="mx-auto max-w-3xl text-center">
          ...
          >
            <span className="inline-flex items-center gap-2 rounded-full border border-beta-mint/20 bg-beta-mint/[0.06] px-4 py-1.5 text-xs font-semibold uppercase tracking-widest text-beta-mint">
              <span className="h-1.5 w-1.5 rounded-full bg-beta-mint" />
              Protocolo Omega Activo
            </span>
          </motion.div>
          ...
          <motion.h1
            ...
            className="mt-8 text-5xl font-black leading-[1.1] tracking-tight text-white sm:text-6xl lg:text-7xl"
          >
            El Futuro de la{' '}
            <span className="text-beta-mint">Gestión Clínica</span>
          </motion.h1>
          ...
          >
            Expediente electrónico, telemedicina, reportes RIPS y finanzas en una sola plataforma.
            Diseñado para clínicas que exigen velocidad, precisión y elegancia.
          </motion.p>
          ...
          >
            ...
            <button className="flex items-center gap-2 rounded-lg border border-white/15 px-8 py-3.5 text-sm font-semibold text-white/70 transition-colors hover:border-white/25 hover:text-white">
              <Play size={16} className="text-beta-mint" />
              Ver Video
            </button>
          </motion.div>
          ...
          >
            <div className="flex h-10 w-6 items-start justify-center rounded-full border border-white/15 p-1.5">
              <motion.div
                ...
                className="h-2 w-1.5 rounded-full bg-beta-mint/50"
              />
            </div>
          </motion.div>
        </div>
